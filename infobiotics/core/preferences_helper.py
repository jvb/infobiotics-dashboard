...
from enthought.traits.api import HasTraits, Instance, Str, Unicode, TraitError

# Local imports.
from enthought.preferences.i_preferences import IPreferences
from enthought.preferences.package_globals import get_default_preferences
