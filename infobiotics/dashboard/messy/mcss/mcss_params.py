...
from enthought.traits.api import Str, Enum, Bool, File, Range, Long
from infobiotics.dashboard.traits.api import FloatGreaterThanZero, LongGreaterThanZero
...
#    model_file = File('model.lpp', exists=True, desc='the model file to simulate')
    ...
    def configure(self, *args, **kwargs):
        ...
        McssParamsController(model=self).configure_traits(kind='modal', *args, **kwargs)

#    def edit(self, **traits):
#        from infobiotics.dashboard.mcss.api import McssParamsController
#        McssParamsController(model=self).edit_traits(kind='nonmodal', *args, **kwargs)
