...
# $Id: mc2_experiment.py 414 2010-01-26 16:07:05Z jvb $
# $HeadURL: https://psiren.cs.nott.ac.uk/repos/infobiotics/dashboard/trunk/infobiotics/dashboard/plugins/pmodelchecker/mc2_experiment.py $
# $Author: jvb $
# $Revision: 414 $
...
import tables
from infobiotics.dashboard.plugins.mcss.mcss_experiment import McssExperiment

from infobiotics.dashboard.shared.unified_logging import unified_logging
logger = unified_logging.get_logger('mc2_experiment')

class MC2Experiment(PModelCheckerExperiment):
    
    parameter_set_name = 'MC2'

    def _group_default(self):
        from mc2_group import mc2_group as group
        return group
...
#    experiment.load('/home/jvb/src/pmodelchecker-0.0.5/examples/MC2examples/NAR_MC2.params')

    experiment.load('/home/jvb/Desktop/motifs/Const/modelChecking/Const_MC2.params') # check this with relative path
#    experiment.temporal_formulas='/home/jvb/Desktop/motifs/Const/modelChecking/formulas.pltl' #TODO check this with relative path
