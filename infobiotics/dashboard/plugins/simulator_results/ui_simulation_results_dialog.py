...
#
# Created: Tue Aug 31 16:37:45 2010
...
class Ui_SimulationResultsDialog(object):
    def setupUi(self, SimulationResultsDialog):
        ...
        SimulationResultsDialog.resize(900, 562)
        ...
        self.gridLayout_5.addWidget(self.file_name_line_edit, 0, 0, 1, 6)
        ...
        self.__runs_calculation_combo_box = QtGui.QComboBox(self.calculate_group_box)
        self.__runs_calculation_combo_box.setObjectName("__runs_calculation_combo_box")
        self.__runs_calculation_combo_box.addItem("")
        self.__runs_calculation_combo_box.setItemText(0, "")
        self.__runs_calculation_combo_box.addItem("")
        self.__runs_calculation_combo_box.addItem("")
        self.__runs_calculation_combo_box.addItem("")
        self.__runs_calculation_combo_box.addItem("")
        ...
        self.__runs_calculation_combo_box.addItem("")
        self.__runs_calculation_combo_box.addItem("")
        self.gridLayout_6.addWidget(self.__runs_calculation_combo_box, 0, 1, 1, 1)
        self.__species_calculation_combo_box = QtGui.QComboBox(self.calculate_group_box)
        self.__species_calculation_combo_box.setObjectName("__species_calculation_combo_box")
        self.__species_calculation_combo_box.addItem("")
        self.__species_calculation_combo_box.setItemText(0, "")
        self.__species_calculation_combo_box.addItem("")
        self.__species_calculation_combo_box.addItem("")
        self.__species_calculation_combo_box.addItem("")
        self.__species_calculation_combo_box.addItem("")
        ...
        self.__species_calculation_combo_box.addItem("")
        self.__species_calculation_combo_box.addItem("")
        self.gridLayout_6.addWidget(self.__species_calculation_combo_box, 0, 2, 1, 1)
        self.__compartments_calculation_combo_box = QtGui.QComboBox(self.calculate_group_box)
        self.__compartments_calculation_combo_box.setObjectName("__compartments_calculation_combo_box")
        self.__compartments_calculation_combo_box.addItem("")
        self.__compartments_calculation_combo_box.setItemText(0, "")
        self.__compartments_calculation_combo_box.addItem("")
        self.__compartments_calculation_combo_box.addItem("")
        self.__compartments_calculation_combo_box.addItem("")
        self.__compartments_calculation_combo_box.addItem("")
        ...
        self.__compartments_calculation_combo_box.addItem("")
        self.__compartments_calculation_combo_box.addItem("")
        self.gridLayout_6.addWidget(self.__compartments_calculation_combo_box, 0, 3, 1, 1)
        self.__timepoints_calculation_combo_box = QtGui.QComboBox(self.calculate_group_box)
        self.__timepoints_calculation_combo_box.setObjectName("__timepoints_calculation_combo_box")
        self.__timepoints_calculation_combo_box.addItem("")
        self.__timepoints_calculation_combo_box.setItemText(0, "")
        self.__timepoints_calculation_combo_box.addItem("")
        self.__timepoints_calculation_combo_box.addItem("")
        self.__timepoints_calculation_combo_box.addItem("")
        self.__timepoints_calculation_combo_box.addItem("")
        ...
        self.__timepoints_calculation_combo_box.addItem("")
        self.__timepoints_calculation_combo_box.addItem("")
        self.gridLayout_6.addWidget(self.__timepoints_calculation_combo_box, 0, 4, 1, 1)
        self._runs_calculation_label = QtGui.QLabel(self.calculate_group_box)
        self._runs_calculation_label.setAlignment(QtCore.Qt.AlignCenter)
        self._runs_calculation_label.setObjectName("_runs_calculation_label")
        self.gridLayout_6.addWidget(self._runs_calculation_label, 1, 1, 1, 1)
        self._species_calculation_label = QtGui.QLabel(self.calculate_group_box)
        self._species_calculation_label.setAlignment(QtCore.Qt.AlignCenter)
        self._species_calculation_label.setObjectName("_species_calculation_label")
        self.gridLayout_6.addWidget(self._species_calculation_label, 1, 2, 1, 1)
        self._compartments_calculation_label = QtGui.QLabel(self.calculate_group_box)
        self._compartments_calculation_label.setAlignment(QtCore.Qt.AlignCenter)
        self._compartments_calculation_label.setObjectName("_compartments_calculation_label")
        self.gridLayout_6.addWidget(self._compartments_calculation_label, 1, 3, 1, 1)
        self._timepoints_calculation_label = QtGui.QLabel(self.calculate_group_box)
        self._timepoints_calculation_label.setAlignment(QtCore.Qt.AlignCenter)
        self._timepoints_calculation_label.setObjectName("_timepoints_calculation_label")
        self.gridLayout_6.addWidget(self._timepoints_calculation_label, 1, 4, 1, 1)
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(":/hist.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.histogram_button.setIcon(icon)
        ...
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap(":/plot_2d.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.plot_timeseries_button.setIcon(icon2)
        ...
        self.__data_combo_box = QtGui.QComboBox(self._data_group_box)
        self.__data_combo_box.setObjectName("__data_combo_box")
        self.__data_combo_box.addItem("")
        self.__data_combo_box.addItem("")
        self.gridLayout_8.addWidget(self.__data_combo_box, 0, 0, 1, 1)
        self._of_selected_data_label = QtGui.QLabel(self._data_group_box)
        self._of_selected_data_label.setAlignment(QtCore.Qt.AlignRight|QtCore.Qt.AlignTrailing|QtCore.Qt.AlignVCenter)
        self._of_selected_data_label.setObjectName("_of_selected_data_label")
        self.gridLayout_8.addWidget(self._of_selected_data_label, 1, 0, 1, 1)
        self.gridLayout_5.addWidget(self._data_group_box, 3, 1, 1, 1)
        ...
        self.select_all_runs_widget = QtGui.QCheckBox(self._runs_group_box)
        ...
        self.random_runs_spinbox = QtGui.QSpinBox(self._runs_group_box)
        ...
        self.compartments_list_widget_filter = QtGui.QLineEdit(self._compartments_group_box)
        ...
        self.gridLayout_5.addWidget(self._runs_species_compartments_splitter, 1, 0, 1, 7)
        self.random_runs_label.setBuddy(self.random_runs_spinbox)

        self.retranslateUi(SimulationResultsDialog)
        self.__runs_calculation_combo_box.setCurrentIndex(0)
        QtCore.QMetaObject.connectSlotsByName(SimulationResultsDialog)
        SimulationResultsDialog.setTabOrder(self.file_name_line_edit, self.select_all_runs_widget)
    ...
    def retranslateUi(self, SimulationResultsDialog):
        ...
        self.__runs_calculation_combo_box.setItemText(1, QtGui.QApplication.translate("SimulationResultsDialog", "mean", None, QtGui.QApplication.UnicodeUTF8))
        self.__runs_calculation_combo_box.setItemText(2, QtGui.QApplication.translate("SimulationResultsDialog", "standard deviation", None, QtGui.QApplication.UnicodeUTF8))
        self.__runs_calculation_combo_box.setItemText(3, QtGui.QApplication.translate("SimulationResultsDialog", "variance", None, QtGui.QApplication.UnicodeUTF8))
        self.__runs_calculation_combo_box.setItemText(4, QtGui.QApplication.translate("SimulationResultsDialog", "median", None, QtGui.QApplication.UnicodeUTF8))
        self.__runs_calculation_combo_box.setItemText(5, QtGui.QApplication.translate("SimulationResultsDialog", "sum", None, QtGui.QApplication.UnicodeUTF8))
        self.__runs_calculation_combo_box.setItemText(6, QtGui.QApplication.translate("SimulationResultsDialog", "minimum", None, QtGui.QApplication.UnicodeUTF8))
        self.__runs_calculation_combo_box.setItemText(7, QtGui.QApplication.translate("SimulationResultsDialog", "maximum", None, QtGui.QApplication.UnicodeUTF8))
        self.__species_calculation_combo_box.setItemText(1, QtGui.QApplication.translate("SimulationResultsDialog", "mean", None, QtGui.QApplication.UnicodeUTF8))
        self.__species_calculation_combo_box.setItemText(2, QtGui.QApplication.translate("SimulationResultsDialog", "standard deviation", None, QtGui.QApplication.UnicodeUTF8))
        self.__species_calculation_combo_box.setItemText(3, QtGui.QApplication.translate("SimulationResultsDialog", "variance", None, QtGui.QApplication.UnicodeUTF8))
        self.__species_calculation_combo_box.setItemText(4, QtGui.QApplication.translate("SimulationResultsDialog", "median", None, QtGui.QApplication.UnicodeUTF8))
        self.__species_calculation_combo_box.setItemText(5, QtGui.QApplication.translate("SimulationResultsDialog", "sum", None, QtGui.QApplication.UnicodeUTF8))
        self.__species_calculation_combo_box.setItemText(6, QtGui.QApplication.translate("SimulationResultsDialog", "minimum", None, QtGui.QApplication.UnicodeUTF8))
        self.__species_calculation_combo_box.setItemText(7, QtGui.QApplication.translate("SimulationResultsDialog", "maximum", None, QtGui.QApplication.UnicodeUTF8))
        self.__compartments_calculation_combo_box.setItemText(1, QtGui.QApplication.translate("SimulationResultsDialog", "mean", None, QtGui.QApplication.UnicodeUTF8))
        self.__compartments_calculation_combo_box.setItemText(2, QtGui.QApplication.translate("SimulationResultsDialog", "standard deviation", None, QtGui.QApplication.UnicodeUTF8))
        self.__compartments_calculation_combo_box.setItemText(3, QtGui.QApplication.translate("SimulationResultsDialog", "variance", None, QtGui.QApplication.UnicodeUTF8))
        self.__compartments_calculation_combo_box.setItemText(4, QtGui.QApplication.translate("SimulationResultsDialog", "median", None, QtGui.QApplication.UnicodeUTF8))
        self.__compartments_calculation_combo_box.setItemText(5, QtGui.QApplication.translate("SimulationResultsDialog", "sum", None, QtGui.QApplication.UnicodeUTF8))
        self.__compartments_calculation_combo_box.setItemText(6, QtGui.QApplication.translate("SimulationResultsDialog", "minimum", None, QtGui.QApplication.UnicodeUTF8))
        self.__compartments_calculation_combo_box.setItemText(7, QtGui.QApplication.translate("SimulationResultsDialog", "maximum", None, QtGui.QApplication.UnicodeUTF8))
        self.__timepoints_calculation_combo_box.setItemText(1, QtGui.QApplication.translate("SimulationResultsDialog", "mean", None, QtGui.QApplication.UnicodeUTF8))
        self.__timepoints_calculation_combo_box.setItemText(2, QtGui.QApplication.translate("SimulationResultsDialog", "standard deviation", None, QtGui.QApplication.UnicodeUTF8))
        self.__timepoints_calculation_combo_box.setItemText(3, QtGui.QApplication.translate("SimulationResultsDialog", "variance", None, QtGui.QApplication.UnicodeUTF8))
        self.__timepoints_calculation_combo_box.setItemText(4, QtGui.QApplication.translate("SimulationResultsDialog", "median", None, QtGui.QApplication.UnicodeUTF8))
        self.__timepoints_calculation_combo_box.setItemText(5, QtGui.QApplication.translate("SimulationResultsDialog", "sum", None, QtGui.QApplication.UnicodeUTF8))
        self.__timepoints_calculation_combo_box.setItemText(6, QtGui.QApplication.translate("SimulationResultsDialog", "minimum", None, QtGui.QApplication.UnicodeUTF8))
        self.__timepoints_calculation_combo_box.setItemText(7, QtGui.QApplication.translate("SimulationResultsDialog", "maximum", None, QtGui.QApplication.UnicodeUTF8))
        self._runs_calculation_label.setText(QtGui.QApplication.translate("SimulationResultsDialog", "runs", None, QtGui.QApplication.UnicodeUTF8))
        self._species_calculation_label.setText(QtGui.QApplication.translate("SimulationResultsDialog", "species", None, QtGui.QApplication.UnicodeUTF8))
        self._compartments_calculation_label.setText(QtGui.QApplication.translate("SimulationResultsDialog", "compartments", None, QtGui.QApplication.UnicodeUTF8))
        self._timepoints_calculation_label.setText(QtGui.QApplication.translate("SimulationResultsDialog", "timepoints", None, QtGui.QApplication.UnicodeUTF8))
...
"NumPy (.npz)", None, QtGui.QApplication.UnicodeUTF8))
        ...
        self.__data_combo_box.setItemText(0, QtGui.QApplication.translate("SimulationResultsDialog", "Amounts", None, QtGui.QApplication.UnicodeUTF8))
        self.__data_combo_box.setItemText(1, QtGui.QApplication.translate("SimulationResultsDialog", "Volumes", None, QtGui.QApplication.UnicodeUTF8))
        self._of_selected_data_label.setText(QtGui.QApplication.translate("SimulationResultsDialog", "<I>of selected</I>", None, QtGui.QApplication.UnicodeUTF8))
