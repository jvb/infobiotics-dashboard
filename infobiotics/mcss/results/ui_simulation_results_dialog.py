...
class Ui_SimulationResultsDialog(object):
    def setupUi(self, SimulationResultsDialog):
        ...
        SimulationResultsDialog.resize(965, 662)
        ...
        self.verticalLayout_2 = QtGui.QVBoxLayout(SimulationResultsDialog)
        ...
        self.plot_histogram_button = QtGui.QCommandLinkButton(SimulationResultsDialog)
    ...
    def retranslateUi(self, SimulationResultsDialog):
        ...
        self.timepoints_data_units_combo_box.setToolTip(QtGui.QApplication.translate("SimulationResultsDialog", "Specifies the units of time used in the simulated model.", None, QtGui.QApplication.UnicodeUTF8))
        self.timepoints_data_units_combo_box.setItemText(0, QtGui.QApplication.translate("SimulationResultsDialog", "years", None, QtGui.QApplication.UnicodeUTF8))
        self.timepoints_data_units_combo_box.setItemText(1, QtGui.QApplication.translate("SimulationResultsDialog", "months", None, QtGui.QApplication.UnicodeUTF8))
        self.timepoints_data_units_combo_box.setItemText(2, QtGui.QApplication.translate("SimulationResultsDialog", "weeks", None, QtGui.QApplication.UnicodeUTF8))
        self.timepoints_data_units_combo_box.setItemText(3, QtGui.QApplication.translate("SimulationResultsDialog", "days", None, QtGui.QApplication.UnicodeUTF8))
        self.timepoints_data_units_combo_box.setItemText(4, QtGui.QApplication.translate("SimulationResultsDialog", "hours", None, QtGui.QApplication.UnicodeUTF8))
        self.timepoints_data_units_combo_box.setItemText(5, QtGui.QApplication.translate("SimulationResultsDialog", "minutes", None, QtGui.QApplication.UnicodeUTF8))
        self.timepoints_data_units_combo_box.setItemText(6, QtGui.QApplication.translate("SimulationResultsDialog", "seconds", None, QtGui.QApplication.UnicodeUTF8))
        self.timepoints_data_units_combo_box.setItemText(7, QtGui.QApplication.translate("SimulationResultsDialog", "milliseconds", None, QtGui.QApplication.UnicodeUTF8))
        self.timepoints_data_units_combo_box.setItemText(8, QtGui.QApplication.translate("SimulationResultsDialog", "microseconds", None, QtGui.QApplication.UnicodeUTF8))
        self.timepoints_data_units_combo_box.setItemText(9, QtGui.QApplication.translate("SimulationResultsDialog", "nanoseconds", None, QtGui.QApplication.UnicodeUTF8))
        self.timepoints_data_units_combo_box.setItemText(10, QtGui.QApplication.translate("SimulationResultsDialog", "picoseconds", None, QtGui.QApplication.UnicodeUTF8))
        self.timepoints_data_units_combo_box.setItemText(11, QtGui.QApplication.translate("SimulationResultsDialog", "femtoseconds", None, QtGui.QApplication.UnicodeUTF8))
        self.timepoints_data_units_combo_box.setItemText(12, QtGui.QApplication.translate("SimulationResultsDialog", "attoseconds", None, QtGui.QApplication.UnicodeUTF8))
        self._timepoints_units_label_2.setText(QtGui.QApplication.translate("SimulationResultsDialog", "to be handled in", None, QtGui.QApplication.UnicodeUTF8))
        self.timepoints_display_units_combo_box.setItemText(0, QtGui.QApplication.translate("SimulationResultsDialog", "years", None, QtGui.QApplication.UnicodeUTF8))
        self.timepoints_display_units_combo_box.setItemText(1, QtGui.QApplication.translate("SimulationResultsDialog", "months", None, QtGui.QApplication.UnicodeUTF8))
        self.timepoints_display_units_combo_box.setItemText(2, QtGui.QApplication.translate("SimulationResultsDialog", "weeks", None, QtGui.QApplication.UnicodeUTF8))
        self.timepoints_display_units_combo_box.setItemText(3, QtGui.QApplication.translate("SimulationResultsDialog", "days", None, QtGui.QApplication.UnicodeUTF8))
        self.timepoints_display_units_combo_box.setItemText(4, QtGui.QApplication.translate("SimulationResultsDialog", "hours", None, QtGui.QApplication.UnicodeUTF8))
        self.timepoints_display_units_combo_box.setItemText(5, QtGui.QApplication.translate("SimulationResultsDialog", "minutes", None, QtGui.QApplication.UnicodeUTF8))
        self.timepoints_display_units_combo_box.setItemText(6, QtGui.QApplication.translate("SimulationResultsDialog", "seconds", None, QtGui.QApplication.UnicodeUTF8))
        self.timepoints_display_units_combo_box.setItemText(7, QtGui.QApplication.translate("SimulationResultsDialog", "milliseconds", None, QtGui.QApplication.UnicodeUTF8))
        self.timepoints_display_units_combo_box.setItemText(8, QtGui.QApplication.translate("SimulationResultsDialog", "microseconds", None, QtGui.QApplication.UnicodeUTF8))
        self.timepoints_display_units_combo_box.setItemText(9, QtGui.QApplication.translate("SimulationResultsDialog", "nanoseconds", None, QtGui.QApplication.UnicodeUTF8))
        self.timepoints_display_units_combo_box.setItemText(10, QtGui.QApplication.translate("SimulationResultsDialog", "picoseconds", None, QtGui.QApplication.UnicodeUTF8))
        self.timepoints_display_units_combo_box.setItemText(11, QtGui.QApplication.translate("SimulationResultsDialog", "femtoseconds", None, QtGui.QApplication.UnicodeUTF8))
        self.timepoints_display_units_combo_box.setItemText(12, QtGui.QApplication.translate("SimulationResultsDialog", "attoseconds", None, QtGui.QApplication.UnicodeUTF8))
        ...
        self._quantities_label_1.setText(QtGui.QApplication.translate("SimulationResultsDialog", "Quantities are in", None, QtGui.QApplication.UnicodeUTF8))
        self.quantities_data_units_combo_box.setToolTip(QtGui.QApplication.translate("SimulationResultsDialog", "Specifies the type of quantities used in the simulated model.", None, QtGui.QApplication.UnicodeUTF8))
        self.quantities_data_units_combo_box.setItemText(0, QtGui.QApplication.translate("SimulationResultsDialog", "molecules", None, QtGui.QApplication.UnicodeUTF8))
        self.quantities_data_units_combo_box.setItemText(1, QtGui.QApplication.translate("SimulationResultsDialog", "moles", None, QtGui.QApplication.UnicodeUTF8))
        self.quantities_data_units_combo_box.setItemText(2, QtGui.QApplication.translate("SimulationResultsDialog", "millimoles", None, QtGui.QApplication.UnicodeUTF8))
        self.quantities_data_units_combo_box.setItemText(3, QtGui.QApplication.translate("SimulationResultsDialog", "micromoles", None, QtGui.QApplication.UnicodeUTF8))
        self.quantities_data_units_combo_box.setItemText(4, QtGui.QApplication.translate("SimulationResultsDialog", "nanomoles", None, QtGui.QApplication.UnicodeUTF8))
        self.quantities_data_units_combo_box.setItemText(5, QtGui.QApplication.translate("SimulationResultsDialog", "picomoles", None, QtGui.QApplication.UnicodeUTF8))
        self.quantities_data_units_combo_box.setItemText(6, QtGui.QApplication.translate("SimulationResultsDialog", "femtomoles", None, QtGui.QApplication.UnicodeUTF8))
        self.quantities_data_units_combo_box.setItemText(7, QtGui.QApplication.translate("SimulationResultsDialog", "attomoles", None, QtGui.QApplication.UnicodeUTF8))
        self._quantities_label_2.setText(QtGui.QApplication.translate("SimulationResultsDialog", "to be interpreted as", None, QtGui.QApplication.UnicodeUTF8))
        self.quantities_display_type_combo_box.setToolTip(QtGui.QApplication.translate("SimulationResultsDialog", "Species the type of quantities to extract from the simulation.", None, QtGui.QApplication.UnicodeUTF8))
        self.quantities_display_type_combo_box.setItemText(0, QtGui.QApplication.translate("SimulationResultsDialog", "molecules", None, QtGui.QApplication.UnicodeUTF8))
        self.quantities_display_type_combo_box.setItemText(1, QtGui.QApplication.translate("SimulationResultsDialog", "concentrations", None, QtGui.QApplication.UnicodeUTF8))
        self.quantities_display_type_combo_box.setItemText(2, QtGui.QApplication.translate("SimulationResultsDialog", "moles", None, QtGui.QApplication.UnicodeUTF8))
        self._quantities_label_3.setText(QtGui.QApplication.translate("SimulationResultsDialog", "and handled in", None, QtGui.QApplication.UnicodeUTF8))
        self.molecules_display_units_label.setText(QtGui.QApplication.translate("SimulationResultsDialog", "molecules", None, QtGui.QApplication.UnicodeUTF8))
        self.moles_display_units_combo_box.setToolTip(QtGui.QApplication.translate("SimulationResultsDialog", "Specifies the units to use when handling quantities as moles.", None, QtGui.QApplication.UnicodeUTF8))
        self.moles_display_units_combo_box.setItemText(0, QtGui.QApplication.translate("SimulationResultsDialog", "moles", None, QtGui.QApplication.UnicodeUTF8))
        self.moles_display_units_combo_box.setItemText(1, QtGui.QApplication.translate("SimulationResultsDialog", "millimoles", None, QtGui.QApplication.UnicodeUTF8))
        self.moles_display_units_combo_box.setItemText(2, QtGui.QApplication.translate("SimulationResultsDialog", "micromoles", None, QtGui.QApplication.UnicodeUTF8))
        self.moles_display_units_combo_box.setItemText(3, QtGui.QApplication.translate("SimulationResultsDialog", "nanomoles", None, QtGui.QApplication.UnicodeUTF8))
        self.moles_display_units_combo_box.setItemText(4, QtGui.QApplication.translate("SimulationResultsDialog", "picomoles", None, QtGui.QApplication.UnicodeUTF8))
        self.moles_display_units_combo_box.setItemText(5, QtGui.QApplication.translate("SimulationResultsDialog", "femtomoles", None, QtGui.QApplication.UnicodeUTF8))
        self.moles_display_units_combo_box.setItemText(6, QtGui.QApplication.translate("SimulationResultsDialog", "attomoles", None, QtGui.QApplication.UnicodeUTF8))
        self.concentrations_display_units_combo_box.setToolTip(QtGui.QApplication.translate("SimulationResultsDialog", "Specifies the units to use when handling quantities as concentrations.", None, QtGui.QApplication.UnicodeUTF8))
        self.concentrations_display_units_combo_box.setItemText(0, QtGui.QApplication.translate("SimulationResultsDialog", "molar", None, QtGui.QApplication.UnicodeUTF8))
        self.concentrations_display_units_combo_box.setItemText(1, QtGui.QApplication.translate("SimulationResultsDialog", "millimolar", None, QtGui.QApplication.UnicodeUTF8))
        self.concentrations_display_units_combo_box.setItemText(2, QtGui.QApplication.translate("SimulationResultsDialog", "micromolar", None, QtGui.QApplication.UnicodeUTF8))
        self.concentrations_display_units_combo_box.setItemText(3, QtGui.QApplication.translate("SimulationResultsDialog", "nanomolar", None, QtGui.QApplication.UnicodeUTF8))
        ...
        self.volumes_data_units_combo_box.setItemText(2, QtGui.QApplication.translate("SimulationResultsDialog", "microlitres", None, QtGui.QApplication.UnicodeUTF8))
        self.volumes_data_units_combo_box.setItemText(3, QtGui.QApplication.translate("SimulationResultsDialog", "nanolitres", None, QtGui.QApplication.UnicodeUTF8))
        self.volumes_data_units_combo_box.setItemText(4, QtGui.QApplication.translate("SimulationResultsDialog", "picolitres", None, QtGui.QApplication.UnicodeUTF8))
        self.volumes_data_units_combo_box.setItemText(5, QtGui.QApplication.translate("SimulationResultsDialog", "femtolitres", None, QtGui.QApplication.UnicodeUTF8))
        self.volumes_data_units_combo_box.setItemText(6, QtGui.QApplication.translate("SimulationResultsDialog", "attolitres", None, QtGui.QApplication.UnicodeUTF8))
        self._volumes_label_2.setText(QtGui.QApplication.translate("SimulationResultsDialog", "to be handled in", None, QtGui.QApplication.UnicodeUTF8))
        self.volumes_display_units_combo_box.setToolTip(QtGui.QApplication.translate("SimulationResultsDialog", "Specifies the units to use when handling volume data.", None, QtGui.QApplication.UnicodeUTF8))
        self.volumes_display_units_combo_box.setItemText(0, QtGui.QApplication.translate("SimulationResultsDialog", "litres", None, QtGui.QApplication.UnicodeUTF8))
        self.volumes_display_units_combo_box.setItemText(1, QtGui.QApplication.translate("SimulationResultsDialog", "millilitres", None, QtGui.QApplication.UnicodeUTF8))
        self.volumes_display_units_combo_box.setItemText(2, QtGui.QApplication.translate("SimulationResultsDialog", "microlitres", None, QtGui.QApplication.UnicodeUTF8))
        self.volumes_display_units_combo_box.setItemText(3, QtGui.QApplication.translate("SimulationResultsDialog", "nanolitres", None, QtGui.QApplication.UnicodeUTF8))
        self.volumes_display_units_combo_box.setItemText(4, QtGui.QApplication.translate("SimulationResultsDialog", "picolitres", None, QtGui.QApplication.UnicodeUTF8))
        self.volumes_display_units_combo_box.setItemText(5, QtGui.QApplication.translate("SimulationResultsDialog", "femtolitres", None, QtGui.QApplication.UnicodeUTF8))
        self.volumes_display_units_combo_box.setItemText(6, QtGui.QApplication.translate("SimulationResultsDialog", "attolitres", None, QtGui.QApplication.UnicodeUTF8))
...
"NumPy (.npz)", None, QtGui.QApplication.UnicodeUTF8))
        ...
        self.plot_histogram_button.setToolTip(QtGui.QApplication.translate("SimulationResultsDialog", "Save timeseries data for selected runs, species and compartments", None, QtGui.QApplication.UnicodeUTF8))
        self.plot_histogram_button.setText(QtGui.QApplication.translate("SimulationResultsDialog", "Plot histogram", None, QtGui.QApplication.UnicodeUTF8))
        self.plot_histogram_button.setDescription(QtGui.QApplication.translate("SimulationResultsDialog", "Plot distribution of species in runs or compartments", None, QtGui.QApplication.UnicodeUTF8))
