...
from enthought.traits.api import HasTraits, Str, DictStrStr, Instance
...
class POptimizerExpect(ParamsExpect):
...
if __name__ == '__main__':
    e = POptimizerExpect(params_program='./expect_tester', params_file='./poptimizer.stdout', args=['0.3'])
#    e = POptimizerExpect(params_file='/home/jvb/src/poptimizer-0.1.5-0.1.5/examples/fourinitial/four_initial_inputpara.xml')
    e.start()
    e.configure_traits()
    if hasattr(e, 'child'): 
