...
virtualenv -p python2.6 --distribute --no-site-packages infobiotics-dashboard
cdsitepackages
ln -s /usr/lib/pymodules/python2.6/vtk
ln -s /usr/lib/python2.6/dist-packages/PyQt4
ln -s /usr/lib/python2.6/dist-packages/sip.so
ln -s /usr/lib/python2.6/dist-packages/sipconfig.py
