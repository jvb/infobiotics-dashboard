...
libraryOfModules basicLibrary
	...
	UnReg({X},{c_1 3:0.5:3 linear, c_2 0.07:0.01:0.07 linear, c_3 3:0.5:3 linear, c_4 0.01:0.01:0.01 linear},{l}) = 
		{
			rules:
	...
	# over a gene Y												   #
	PosReg({X,Y},{c_1 0:0.5:3 linear,c_2 0:0.5:3 linear,c_3 0:0.5:5 linear, c_4 0.05:0.01:1 linear, c_5 0:0.5:5 linear, 
					  c_6 0.05:0.01:1 linear},{l}) =
		{
			rules:
	...
	# over a gene Y													#
	NegReg({X,Y},{c_1 1:1:1 linear, c_2 0.8:0.1:0.8 linear},{l}) =
		{
			rules:
	...
	# X over a gene Y #
	CoopNegReg({X,Y},{c_1 0:0.5:3 linear,c_2 0:0.5:3 linear,c_3 0:0.5:5 linear, 
                      c_4 0.05:0.01:1 linear, c_5 0:0.5:5 linear, c_6 0.05:0.01:1 linear},{l}) =
		{
		rules:
	      	r1: [ proteinX + geneY ]_l -c_1-> [ proteinX_geneY ]_l 
	      	r2: [ proteinX_geneY ]_l -c_2-> [ proteinX + geneY ]_l 
