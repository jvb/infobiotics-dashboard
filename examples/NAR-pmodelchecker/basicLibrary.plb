...
libraryOfModules basicLibrary
	...
	UnReg({X},{c_1 0:0.0001:0.2 linear, c_2 0:0.001:0.01 linear, c_3 0:0.01:0.05 linear, c_4 0:0.000001:0.001 linear},{l}) = 
		{
			rules:
	...
	# over a gene Y												   #
	PosReg({X,Y},{c_1 0:0.001:0.1 linear,c_2 0:0.001:0.2 linear,c_3 0:0.001:0.1 linear, c4 0:0.001:0.01 linear, c5 0:0.001:0.05 linear, 
					  c6 0:0.000001:0.001 linear},{l}) =
		{
			rules:
	...
	# over a gene Y													#
	NegReg({X,Y},{c_1 0:0.001:0.1 linear, c_2 0:0.001:0.2 linear},{l}) =
		{
			rules:
