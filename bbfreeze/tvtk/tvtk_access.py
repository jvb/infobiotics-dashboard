# https://github.com/enthought/mayavi/blob/master/docs/pdf/tvtk/tvtk.pdf?raw=true
...
#print 'debugging tvtk.tvtk_access start'
...
#print 'debugging tvtk.tvtk_access stop'
