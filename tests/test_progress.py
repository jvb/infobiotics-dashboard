...
class TestProgress(unittest.TestCase):
    ...
    def test_mcss(self):
        ...
        e = experiment('../examples/quickstart-NAR/simulation.params')
        e.perform()
    ...
    def test_prism(self):
        ...
        e = experiment('../examples/quickstart-NAR/model_checking_prism.params')
        e.perform()
    ...
    def test_mc2(self):
        ...
        e = experiment('../examples/quickstart-NAR/model_checking_mc2.params')
        e.perform()
    ...
    def test_poptimizer(self):
        ...
        e = experiment('../examples/quickstart-NAR/optimisation.params')
        e.perform()
