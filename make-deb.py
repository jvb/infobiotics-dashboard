...
p['/usr/share/infobiotics-dashboard']=[
    'commons/traits/float_greater_than_zero.py',
    'commons/traits/__init__.py',
    'commons/traits/interfaces.py',
    'commons/traits/int_greater_than_zero.py',
    'commons/traits/float_with_minimum.py',
    'commons/traits/api.py',
    'commons/traits/file_wrapper.py',
    'commons/traits/relative_directory.py',
    'commons/traits/relative_file.py',
    'commons/traits/ui/__init__.py',
    'commons/traits/ui/fixed_file_dialog.py',
    'commons/traits/ui/helpful_controller.py',
    'commons/traits/ui/api.py',
    'commons/traits/ui/qt4/__init__.py',
    'commons/traits/ui/qt4/api.py',
    'commons/traits/ui/qt4/relative_file_editor.py',
    'commons/traits/ui/qt4/relative_directory_editor.py',
    'commons/traits/long_greater_than_zero.py',
    'commons/__init__.py',
    'commons/colours.py',
    'commons/unified_logging.py',
    'commons/lists.py',
    'commons/md5sum.py',
    'commons/api.py',
    'commons/files.py',
    ...
    'commons/dicts.py',
    'commons/qt4.py',
    'commons/sequences.py',
    'commons/webbrowsing.py',
