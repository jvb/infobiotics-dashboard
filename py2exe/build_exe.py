'''Fixed deprecated import of sets. Need to overwrite:
    C:\Python26\lib\site-packages\py2exe\build_exe.py
'''
...
import marshal
import zipfile
#import sets # commented out by jvb
import tempfile
import struct
import re
...
#        templates = sets.Set() # fixed by jvb
        templates = set()
